    ...
    <div class="bg-white shadow-lg rounded-lg p-4">
      <div class="flex flex-col md:flex-row items-center justify-between mb-4 mt-16 gap-4">
        <div class="w-3/4 text-center md:text-left">
          <h1 class="text-4xl font-bold text-primary mb-2">Shows</h1>
          <p class="text-dark leading-relaxed">
            Welcome to the Movies section! Here, you can explore a wide variety
            of films from different genres and eras. Whether you're a fan of
            action, drama, comedy, or documentaries, there's something for
            everyone.
          </p>
        </div>
