      ...
      >
        <div class="flex w-full gap-4">
          <div class="w-3/4 text-center md:text-left">
            <h1 class="text-4xl font-bold text-primary mb-2">Movies</h1>
            <p class="text-dark leading-relaxed">
              Welcome to the Movies section! Here, you can explore a wide
              variety of films from around the world. Discover top-rated
              blockbusters, popular hits, and critically acclaimed cinema.
            </p>
          </div>
